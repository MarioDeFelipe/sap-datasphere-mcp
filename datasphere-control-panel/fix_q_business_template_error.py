"""
Fix Q Business Template Literal Error
This script fixes the template literal syntax error in the Q Business Lambda function
"""

import boto3
import json

def create_fixed_q_business_app():
    """Create fixed Q Business app without template literal errors"""
    ...
    <body>
        ...
        <script>
            ...
            function generateQResponse(question) {
                const responses = {
                    'quality': 'Based on your data catalog, here are the top 5 data products with highest quality scores:<br><br>1. <strong>Customer_Master_Data</strong> - 98% quality (Finance domain)<br>2. <strong>Sales_Transactions_Daily</strong> - 96% quality (Sales domain)<br>3. <strong>Product_Catalog_Master</strong> - 95% quality (Operations domain)<br>4. <strong>Employee_Directory</strong> - 94% quality (HR domain)<br>5. <strong>Financial_GL_Accounts</strong> - 93% quality (Finance domain)<br><br>All these products have completeness scores above 95% and are updated daily.',
                    
                    'trending': 'Here are the trending data products this month (based on usage increase):<br><br>📈 <strong>Customer_Churn_Predictions</strong> - 340% usage increase<br>📈 <strong>Sales_Forecast_Models</strong> - 280% usage increase<br>📈 <strong>Marketing_Campaign_Results</strong> - 220% usage increase<br>📈 <strong>Supply_Chain_Metrics</strong> - 180% usage increase<br><br>The increase is driven by Q4 planning activities and ML model training.',
                    
                    'access': 'Based on your role as Data Analyst, you have access to 892 out of 1,247 data products:<br><br>✅ <strong>Sales Analysis Products:</strong> 156 products available<br>• Sales_Transactions_Daily, Weekly, Monthly<br>• Customer_Purchase_History<br>• Product_Performance_Metrics<br>• Regional_Sales_Summary<br><br>🔒 <strong>Restricted:</strong> 45 products require additional permissions<br>• Employee_Salary_Data (HR approval needed)<br>• Customer_PII_Details (Privacy officer approval)',
                    
                    'attention': 'Here are 8 data products that need attention:<br><br>🔴 <strong>Critical Issues (3):</strong><br>• Inventory_Levels - 72 hours since last update<br>• Customer_Support_Tickets - Quality score dropped to 67%<br>• Vendor_Payments - Missing 15% of records<br><br>🟡 <strong>Warnings (5):</strong><br>• Marketing_Leads - Completeness at 85%<br>• Product_Reviews - Response time increased 40%<br>• Shipping_Tracking - 3 failed sync attempts',
                    
                    'improve': 'Here are my recommendations to improve data quality across your organization:<br><br>🎯 <strong>Immediate Actions:</strong><br>• Implement automated data validation rules<br>• Set up real-time monitoring dashboards<br>• Establish data stewardship roles<br><br>📊 <strong>Medium-term Goals:</strong><br>• Deploy data profiling tools<br>• Create data quality scorecards<br>• Implement data lineage tracking<br><br>🚀 <strong>Long-term Strategy:</strong><br>• Build a data governance framework<br>• Establish data quality KPIs<br>• Create self-service data quality tools'
                };
...
def lambda_handler(event, context):
    """Fixed Lambda handler without template literal errors"""
    ...
    try:
        ...
        if path == '/' and method == 'GET':
            # Return fixed control panel
            html_content = create_fixed_q_business_app()
            return {
                'statusCode': 200,
                'headers': {
