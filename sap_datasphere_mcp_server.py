...
async def handle_list_tools() -> list[Tool]:
    ...
    return [
        ...
        Tool(
            name="search_kpis",
            description="Search and discover KPIs using advanced query syntax with scope-based filtering and faceted search capabilities. Automatically adds the KPI search scope (comsapcatalogsearchprivateSearchKPIsAdmin) to queries. Supports faceted search by objectType, spaceId, category, and business area. Returns KPI metadata including names, descriptions, current values, targets, and performance status.",
            inputSchema={
                "type": "object",
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "Search terms for KPI discovery (scope prefix added automatically). Example: 'revenue growth' or '(revenue OR profit) AND quarterly'"
                    },
                    "facets": {
                        "type": "string",
                        "description": "Comma-separated facets to include in results (objectType,spaceId,category,businessArea)"
                    },
                    "top": {
                        "type": "integer",
                        "description": "Maximum results to return (default: 50, max: 500)",
        ...
        Tool(
            ...
            description="Retrieve detailed KPI metadata including calculation logic, data sources, thresholds, historical performance, and business context. Returns formula, calculation frequency, aggregation method, data refresh schedule, targets, thresholds (excellent/good/warning/critical), historical values, active alerts, stakeholders, and AI-powered performance analysis with recommendations.",
            inputSchema={
                "type": "object",
                "properties": {
                    "kpi_id": {
                    ...
                    "include_history": {
                        "type": "boolean",
                        "description": "Include historical values (default: false)",
                        "default": False
                    },
                    "include_lineage": {
                        "type": "boolean",
                    ...
                    "history_period": {
                        "type": "string",
                        "description": "History period: 1M (1 month), 3M (3 months), 6M (6 months), 1Y (1 year)",
                        "enum": ["1M", "3M", "6M", "1Y"]
                    }
                },
                "required": ["kpi_id"]
        ...
        Tool(
            name="list_all_kpis",
            description="Get comprehensive inventory of all defined KPIs across all accessible spaces with filtering and categorization. Returns KPI list with performance status, category breakdown, business area distribution, and overall health scoring. Includes summary statistics showing counts by status (Excellent/Good/Warning/Critical), category, and business area. Provides health score (A-F grade) for the KPI portfolio.",
            inputSchema={
                "type": "object",
                "properties": {
                    "space_id": {
                    ...
                    "category": {
                        "type": "string",
                        "description": "Filter by KPI category (Revenue, Profitability, Customer Experience, etc.)"
                    },
                    "business_area": {
                        "type": "string",
                        "description": "Filter by business area (Finance, Sales, Operations, HR, IT)"
                    },
                    "status": {
                        "type": "string",
                    ...
                    "include_inactive": {
                        "type": "boolean",
                        "description": "Include inactive KPIs (default: false)",
                        "default": False
                    },
                    "top": {
                        "type": "integer",
        ...
        # PHASE 7: System Monitoring & Administration Tools (7 tools)
        Tool(
            name="get_systems_overview",
            description="Get comprehensive landscape overview of all registered systems, connections, and their health status. Returns tenant information, connected systems (SAP S/4HANA, Salesforce, etc.) with health status, connection metrics (response time, success rate, data volume), active data flows, space information, and summary statistics. Optionally performs real-time health checks. Essential for system administration and monitoring.",
            inputSchema={
                "type": "object",
                "properties": {
                    "include_details": {
                    ...
                    "health_check": {
                        "type": "boolean",
                        "description": "Perform real-time health check (default: false, adds latency)",
                        "default": False
                    }
                }
            }
        ...
        Tool(
            ...
            description="Search and filter system activity logs with advanced filtering and faceted analysis capabilities. Search across error logs, warnings, info messages, and debug output. Filter by log level (ERROR/WARN/INFO/DEBUG), component (DataFlow, Authentication, Connection, Query), user, time range. Returns log entries with timestamps, messages, stack traces, correlation IDs, faceted analysis showing distributions by level/component/time, and time-based aggregations for pattern detection.",
            inputSchema={
                "type": "object",
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "Search query for log content (searches across message, details, tags)"
                    },
                    "level": {
                        "type": "string",
                    ...
                    "component": {
                        "type": "string",
                        "description": "System component filter (DataFlow, Authentication, Connection, Query, etc.)"
                    },
                    "user_id": {
                        "type": "string",
                    ...
                    "start_time": {
                        "type": "string",
                        "description": "Start time in ISO 8601 format (e.g., '2024-12-08T00:00:00Z')"
                    },
                    "end_time": {
                        "type": "string",
                        "description": "End time in ISO 8601 format (e.g., '2024-12-09T23:59:59Z')"
                    },
                    "facets": {
                        "type": "string",
                        "description": "Comma-separated facets to include (level,component,tags)"
                    },
                    "top": {
                        "type": "integer",
                        "description": "Maximum results (default: 100, max: 1000)",
        ...
        Tool(
            ...
            description="Export system logs for offline analysis with various format options (JSON, CSV, XML) and filtering capabilities. Returns download URL with expiration time, export metadata (record count, file size, format), and applied filters. Maximum 100,000 records per export. Use for compliance auditing, troubleshooting, and long-term log retention.",
            inputSchema={
                "type": "object",
                "properties": {
                    "format": {
                    ...
                    "max_records": {
                        "type": "integer",
                        "description": "Maximum records (default: 10000, max: 100000)",
                        "default": 10000
                    },
                    "include_details": {
                        "type": "boolean",
                        "description": "Include detailed information (stack traces, full context)",
                        "default": True
                    }
                }
            }
        ...
        Tool(
            ...
            description="Analyze logs with dimensional filtering to identify patterns, trends, and anomalies. Returns faceted analysis showing log distributions by level/component/hour/user, trend analysis (error rate changes, top errors), and detected anomalies (error spikes, unusual patterns). Provides time-based aggregations (hourly counts), performance metrics, and AI-powered anomaly detection. Essential for proactive monitoring and incident investigation.",
            inputSchema={
                "type": "object",
                "properties": {
                    "facet_fields": {
                        "type": "string",
                        "description": "Comma-separated facet fields (level,component,hourly,users)"
                    },
                    "start_time": {
                        "type": "string",
        ...
        Tool(
            name="list_users",
            description="List all users in the tenant with their roles, permissions, and activity status. Returns user profiles (name, email, department, manager), account status (Active/Inactive/Locked), assigned roles, space access, permissions, activity metrics (last login, login count, sessions), and summary statistics showing user distribution by role, department, and status. Essential for user administration and access governance.",
            inputSchema={
                "type": "object",
                "properties": {
                    "status": {
                    ...
                    "role": {
                        "type": "string",
                        "description": "Filter by role (DWC_ADMIN, DWC_ANALYST, SPACE_VIEWER, etc.)"
                    },
                    "space_id": {
                        "type": "string",
                        "description": "Filter by space access"
                    },
                    "include_permissions": {
                        "type": "boolean",
                        "description": "Include detailed permissions (default: false)",
                        "default": False
                    },
                    "top": {
                        "type": "integer",
        ...
        Tool(
            ...
            description="Retrieve detailed user permissions and access rights across spaces and objects. Returns global permissions, space-specific permissions (per-space roles and access), object-level permissions (table/view access), inherited permissions, data access restrictions (PII, security classifications), and permission grant history. Includes security risk assessment. Use for access governance, compliance auditing, and troubleshooting permission issues.",
            inputSchema={
                "type": "object",
                "properties": {
                    "user_id": {
                    ...
                    "space_id": {
                        "type": "string",
                        "description": "Filter by specific space (optional)"
                    },
                    "include_inherited": {
                        "type": "boolean",
                        "description": "Include inherited permissions from roles (default: true)",
                        "default": True
                    }
                },
                "required": ["user_id"]
        ...
        Tool(
            ...
            description="Get comprehensive user information including profile, activity, and audit trail. Returns complete user profile (personal info, department, job title, manager, location), account details (creation date, MFA status, password policy), activity metrics (recent queries, dashboards viewed, reports generated), recent actions with timestamps, role assignment history, space access patterns, and complete audit trail. Use for user management, activity monitoring, and compliance reporting.",
            inputSchema={
                "type": "object",
                "properties": {
                    "user_id": {
                    ...
                    "include_audit": {
                        "type": "boolean",
                        "description": "Include audit trail (default: false)",
                        "default": False
                    },
                    "activity_days": {
                        "type": "integer",
                        "description": "Days of activity to include (default: 30)",
                        "default": 30
                    }
                },
                "required": ["user_id"]
  ...
  <edmx:DataServices>
    ...
    # ========================================================================
        ...
        if DATASPHERE_CONFIG["use_mock_data"]:
            ...
            query_lower = query.lower()
            filtered_kpis = [
                kpi for kpi in mock_kpis
                if query_lower in kpi["name"].lower() or
                   query_lower in kpi["description"].lower() or
                   query_lower in kpi["category"].lower()
            ]

            result = {
                "search_query": f"SCOPE:comsapcatalogsearchprivateSearchKPIsAdmin {query}",
                "kpis": filtered_kpis[skip:skip+top],
                "count": len(filtered_kpis) if include_count else None,
                "facets": {
                    "objectType": [{"value": "KPI", "count": len(filtered_kpis)}],
                    "category": [
                        {"value": "Revenue", "count": 1},
                        {"value": "Customer Experience", "count": 1}
                    ]
                } if facets else None
            }
            ...
            return [types.TextContent(
                type="text",
                text=f"KPI Search Results:\n\n{json.dumps(result, indent=2)}\n\nNote: Mock data. Configure OAuth to access real KPIs."
            )]
        else:
            if not datasphere_connector:
                return [types.TextContent(
                    type="text",
                    text="Error: OAuth connector not initialized. Cannot search KPIs."
                )]
            ...
            try:
                ...
                logger.error(f"Error searching KPIs: {str(e)}")
                return [types.TextContent(
                    type="text",
                    text=f"Error searching KPIs: {str(e)}"
                )]

    elif name == "get_kpi_details":
        kpi_id = arguments["kpi_id"]
        include_history = arguments.get("include_history", False)
        include_lineage = arguments.get("include_lineage", False)
        history_period = arguments.get("history_period")
        ...
        if DATASPHERE_CONFIG["use_mock_data"]:
            ...
            mock_kpi_details = {
                ...
                "description": "Measures percentage growth in revenue compared to previous quarter",
                "category": "Revenue",
                "businessArea": "Finance",
                "spaceId": "FINANCE_ANALYTICS",
                "spaceName": "Finance Analytics",
                ...
                "thresholds": {
                    "excellent": {"condition": ">= 20", "color": "darkgreen"},
                    "good": {"condition": "15-20", "color": "green"},
                    "warning": {"condition": "10-15", "color": "yellow"},
                    "critical": {"condition": "< 10", "color": "red"}
                }
            }

            if include_history:
                mock_kpi_details["historicalValues"] = [
                    {"period": "Q3 2024", "value": 8.2, "status": "Critical"},
                    {"period": "Q2 2024", "value": 18.5, "status": "Good"}
                ]

            # Performance analysis
            current = mock_kpi_details["currentValue"]["value"]
            target = mock_kpi_details["targets"]["targetValue"]
            analysis = {
                "performance_status": "Below Target" if current < target else "Meeting Target",
                "target_achievement": f"{(current/target*100):.1f}%",
                "gap_to_target": target - current
            }

            recommendations = []
            if current < target:
                recommendations.append(f"Focus on closing the {target - current:.1f} point gap to target")
            recommendations.append("Review quarterly growth trends for patterns")

            result = {
                "kpi_details": mock_kpi_details,
                "analysis": analysis,
            ...
            return [types.TextContent(
                type="text",
                text=f"KPI Details for {kpi_id}:\n\n{json.dumps(result, indent=2)}\n\nNote: Mock data. Configure OAuth to access real KPI details."
            )]
        else:
            if not datasphere_connector:
                return [types.TextContent(
                    type="text",
                    text="Error: OAuth connector not initialized. Cannot get KPI details."
                )]

            try:
                # Build URL and parameters
                endpoint = f"/api/v1/datasphere/kpis/{kpi_id}"
                params = {}
                if include_history:
                ...
                # Make request
                kpi_data = await datasphere_connector.get(endpoint, params=params)
                ...
                analysis = {
                    "performance_status": "Below Target" if current_value < target_value else "Meeting Target",
                ...
                logger.error(f"Error getting KPI details: {str(e)}")
                return [types.TextContent(
                    type="text",
                    text=f"Error getting KPI details: {str(e)}"
                )]

    elif name == "list_all_kpis":
        space_id = arguments.get("space_id")
        category = arguments.get("category")
        business_area = arguments.get("business_area")
        ...
        if DATASPHERE_CONFIG["use_mock_data"]:
            ...
            # Client-side filtering
            filtered_kpis = mock_kpis
            if space_id:
                filtered_kpis = [k for k in filtered_kpis if k["spaceId"] == space_id]
            if category:
                filtered_kpis = [k for k in filtered_kpis if k["category"] == category]
            if business_area:
                filtered_kpis = [k for k in filtered_kpis if k["businessArea"] == business_area]
            if status:
                filtered_kpis = [k for k in filtered_kpis if k["status"] == status]
            if owner:
                filtered_kpis = [k for k in filtered_kpis if k["owner"] == owner]

            # Health scoring
            status_counts = {"Excellent": 1, "Good": 1, "Warning": 1, "Critical": 0}
            total = sum(status_counts.values())
            health_score = (status_counts["Excellent"] * 4 + status_counts["Good"] * 3 +
                          status_counts["Warning"] * 2 + status_counts["Critical"] * 1) / total if total > 0 else 0

            result = {
                "kpis": filtered_kpis[skip:skip+top],
                "summary": {
                    "totalKpis": len(filtered_kpis),
                    "byStatus": status_counts,
                    "byCategory": {"Revenue": 1, "Customer Experience": 1, "Profitability": 1}
                },
                "analysis": {
                    "total_kpis": len(filtered_kpis),
                    "health_score": {"score": round(health_score, 2), "grade": "B"}
                },
                "filters_applied": {
                    "space_id": space_id,
                    "category": category,
            ...
            return [types.TextContent(
                type="text",
                text=f"KPI Inventory:\n\n{json.dumps(result, indent=2)}\n\nNote: Mock data. Configure OAuth to access real KPIs."
            )]
        else:
            if not datasphere_connector:
                return [types.TextContent(
                    type="text",
                    text="Error: OAuth connector not initialized. Cannot list KPIs."
                )]
            ...
            try:
                ...
                result = {
                    ...
                    "analysis": {
                        ...
                        "health_score": {"score": round(health_score, 2), "grade": "B" if health_score >= 3 else "C"}
                    },
                    "filters_applied": {
                        "space_id": space_id,
                        "category": category,
                ...
                return [types.TextContent(
                    type="text",
                    text=f"Error listing KPIs: {str(e)}"
                )]

    # ========================================================================
    # PHASE 7: SYSTEM MONITORING & ADMINISTRATION TOOLS
    # ========================================================================

    elif name == "get_systems_overview":
        include_details = arguments.get("include_details", False)
        health_check = arguments.get("health_check", False)

        if DATASPHERE_CONFIG["use_mock_data"]:
            # Mock systems overview
            result = {
                "tenant": {
                    "id": "tenant-12345",
            ...
            return [types.TextContent(
                type="text",
                text=f"Systems Overview:\n\n{json.dumps(result, indent=2)}\n\nNote: Mock data. Configure OAuth for real system monitoring."
            )]
        else:
            if not datasphere_connector:
                return [types.TextContent(
                    type="text",
                    text="Error: OAuth connector not initialized. Cannot get systems overview."
                )]
            ...
            try:
                ...
                logger.error(f"Error getting systems overview: {str(e)}")
                return [types.TextContent(
                    type="text",
                    text=f"Error getting systems overview: {str(e)}"
                )]

    elif name == "search_system_logs":
        ...
        if DATASPHERE_CONFIG["use_mock_data"]:
            ...
            if query:
                query_lower = query.lower()
                filtered_logs = [log for log in filtered_logs if query_lower in log["message"].lower()]

            result = {
                "logs": filtered_logs[skip:skip+top],
            ...
            return [types.TextContent(
                type="text",
                text=f"System Logs:\n\n{json.dumps(result, indent=2)}\n\nNote: Mock data. Configure OAuth for real system logs."
            )]
        else:
            if not datasphere_connector:
                return [types.TextContent(
                    type="text",
                    text="Error: OAuth connector not initialized. Cannot search logs."
                )]
    ...
    elif name == "download_system_logs":
        ...
        if DATASPHERE_CONFIG["use_mock_data"]:
            ...
            return [types.TextContent(
                type="text",
                text=f"Log Export:\n\n{json.dumps(result, indent=2)}\n\nNote: Mock data. Configure OAuth for real log exports."
            )]
        else:
            if not datasphere_connector:
                return [types.TextContent(
                    type="text",
                    text="Error: OAuth connector not initialized. Cannot download logs."
                )]
            ...
            try:
                ...
                return [types.TextContent(
                    type="text",
                    text=f"Error downloading logs: {str(e)}"
                )]

    elif name == "get_system_log_facets":
        ...
        if DATASPHERE_CONFIG["use_mock_data"]:
            # Mock log facet analysis
            result = {
                "analysisId": "analysis-12345",
                "timeRange": {
                    "startTime": start_time or "2024-12-08T00:00:00Z",
                    "endTime": end_time or "2024-12-09T23:59:59Z",
                    "duration": "48 hours"
                },
                "totalRecords": 15678,
                "facets": {
            ...
            return [types.TextContent(
                type="text",
                text=f"Log Facet Analysis:\n\n{json.dumps(result, indent=2)}\n\nNote: Mock data. Configure OAuth for real log analysis."
            )]
        else:
            if not datasphere_connector:
                return [types.TextContent(
                    type="text",
                    text="Error: OAuth connector not initialized. Cannot analyze logs."
                )]
        ...
        if DATASPHERE_CONFIG["use_mock_data"]:
            ...
            result = {
                "users": filtered_users[skip:skip+top],
                "count": len(filtered_users),
                "summary": {
                    "totalUsers": len(filtered_users),
                    "activeUsers": 2,
                    "byRole": {
                        "DWC_ADMIN": 1,
                        "DWC_ANALYST": 1,
            ...
            return [types.TextContent(
                type="text",
                text=f"User List:\n\n{json.dumps(result, indent=2)}\n\nNote: Mock data. Configure OAuth for real user data."
            )]
        else:
            if not datasphere_connector:
                return [types.TextContent(
                    type="text",
                    text="Error: OAuth connector not initialized. Cannot list users."
                )]
        ...
        if DATASPHERE_CONFIG["use_mock_data"]:
                ...
                "spacePermissions": [
                    {
                        ...
                        "spaceName": "Finance Analytics",
                        "role": "Viewer",
                        "permissions": ["READ_OBJECTS", "EXECUTE_QUERIES", "VIEW_DATA"],
            ...
            return [types.TextContent(
                type="text",
                text=f"User Permissions:\n\n{json.dumps(result, indent=2)}\n\nNote: Mock data. Configure OAuth for real permissions."
            )]
        else:
            if not datasphere_connector:
                return [types.TextContent(
                    type="text",
                    text="Error: OAuth connector not initialized. Cannot get user permissions."
                )]

            try:
                endpoint = f"/api/v1/datasphere/users/{user_id}/permissions"
                params = {}
                ...
                return [types.TextContent(
                    type="text",
                    text=f"Error getting user permissions: {str(e)}"
                )]
        ...
        activity_days = arguments.get("activity_days", 30)
        ...
        if DATASPHERE_CONFIG["use_mock_data"]:
            ...
            result = {
                ...
                ] if include_audit else None
            }

            return [types.TextContent(
                type="text",
                text=f"User Details:\n\n{json.dumps(result, indent=2)}\n\nNote: Mock data. Configure OAuth for real user details."
            )]
        else:
            if not datasphere_connector:
                return [types.TextContent(
                    type="text",
                    text="Error: OAuth connector not initialized. Cannot get user details."
                )]

            try:
                endpoint = f"/api/v1/datasphere/users/{user_id}"
                params = {}
                ...
                return [types.TextContent(
                    type="text",
                    text=f"Error getting user details: {str(e)}"
                )]
