...
def print_connection_summary():
    ...
    print("   • Tenant ID: <your-tenant-id>")
    print("   • Region: EU10 (Europe)")
    print("   • Base URL: https://your-tenant.eu10.hcs.cloud.sap")
    print("   • Authentication: Basic Auth (username/password) ✅")
    print("   • Service Type: SAP Analytics Cloud / Datasphere")
    
    print("\n🌐 WORKING ENDPOINTS:")
    working_endpoints = [
        "https://your-tenant.eu10.hcs.cloud.sap/health",
        "https://api-your-tenant.eu10.hcs.cloud.sap/health",
        "https://<your-tenant-id>-api.eu10.hcs.cloud.sap/health",
        "https://rest-your-tenant.eu10.hcs.cloud.sap/health"
    ]
    ...
    print("     https://your-tenant.eu10.hcs.cloud.sap")
...
def create_connection_config():
    ...
    config = {
        ...
        "api_subdomains": [
            "api-your-tenant.eu10.hcs.cloud.sap",
            "<your-tenant-id>-api.eu10.hcs.cloud.sap",
            "rest-your-tenant.eu10.hcs.cloud.sap"
        ],
        "authentication": {
            "type": "basic_auth",
            "username": "GE230769",
