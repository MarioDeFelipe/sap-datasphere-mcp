...
class AuthorizationManager:
    ...
    TOOL_PERMISSIONS: Dict[str, ToolPermission] = {
        ...
        "search_kpis": ToolPermission(
            ...
            category=ToolCategory.METADATA,
            requires_consent=False,
            description="Search and discover KPIs with advanced filtering",
            risk_level="low"
        ),
        "get_kpi_details": ToolPermission(
            tool_name="get_kpi_details",
            permission_level=PermissionLevel.READ,
            category=ToolCategory.METADATA,
            requires_consent=False,
            description="Get detailed KPI metadata and performance analysis",
            risk_level="low"
        ),
        "list_all_kpis": ToolPermission(
            tool_name="list_all_kpis",
            permission_level=PermissionLevel.READ,
            category=ToolCategory.METADATA,
            requires_consent=False,
            description="Comprehensive KPI inventory with health scoring",
            risk_level="low"
        ),

        # Phase 7: System Monitoring Tools
        "get_systems_overview": ToolPermission(
            tool_name="get_systems_overview",
            permission_level=PermissionLevel.READ,
            category=ToolCategory.ADMINISTRATION,
            requires_consent=False,
            description="Get landscape overview with system health monitoring",
            risk_level="low"
        ),
        "search_system_logs": ToolPermission(
            tool_name="search_system_logs",
            permission_level=PermissionLevel.READ,
            category=ToolCategory.ADMINISTRATION,
            requires_consent=False,
            description="Search and filter system activity logs",
            risk_level="low"
        ),
        "download_system_logs": ToolPermission(
            tool_name="download_system_logs",
            permission_level=PermissionLevel.ADMIN,
            category=ToolCategory.ADMINISTRATION,
            requires_consent=True,
            description="Export system logs for offline analysis (sensitive operation)",
            risk_level="medium"
        ),
        "get_system_log_facets": ToolPermission(
            tool_name="get_system_log_facets",
            permission_level=PermissionLevel.READ,
            category=ToolCategory.ADMINISTRATION,
            requires_consent=False,
            description="Analyze log patterns, trends, and anomalies",
            risk_level="low"
        ),
        ...
        "list_users": ToolPermission(
            ...
            category=ToolCategory.ADMINISTRATION,
            requires_consent=False,
            description="List all users with roles and activity status",
            risk_level="medium"
        ),
        "get_user_permissions": ToolPermission(
            ...
            category=ToolCategory.ADMINISTRATION,
            requires_consent=False,
            description="Get detailed user permissions across spaces and objects",
            risk_level="medium"
        ),
        "get_user_details": ToolPermission(
            ...
            category=ToolCategory.ADMINISTRATION,
            requires_consent=False,
            description="Get comprehensive user profile with audit trail",
            risk_level="medium"
        ),
    }
