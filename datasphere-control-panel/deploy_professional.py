#!/usr/bin/env python3
"""
Deploy Professional Dashboard - Simple approach
"""
...
def main():
    ...
    try:
        # Read the professional dashboard code
        import os
        current_dir = os.getcwd()
        print(f"📋 Current directory: {current_dir}")
        
        file_path = os.path.join(current_dir, 'datasphere-control-panel', 'restore_professional_dashboard.py')
        ...
        if os.path.exists(file_path) and os.path.getsize(file_path) > 0:
            ...
            print("❌ File not found or empty, using embedded code")
            # Use embedded code as fallback
            code_content = '''#!/usr/bin/env python3
"""
Professional Ailien Platform Control Panel - Embedded Version
"""
        ...
        try:
            ...
            with urllib.request.urlopen(req, timeout=10) as response:
                if response.status == 200:
                    ...
                    if "1,247" in content and "Total Products" in content:
                        print("✅ Professional dashboard metrics detected!")
                        ...
                        print("⚠️ Professional dashboard not fully deployed")
                        return False
