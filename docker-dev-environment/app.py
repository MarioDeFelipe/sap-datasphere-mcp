...
def get_api_explorer_html():
    """Get the API Explorer HTML template"""
    return """
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>API Explorer - SAP Datasphere Control Panel</title>
        <style>
            * {
                margin: 0;
                padding: 0;
    ...
    <body>
        ...
        <div class="container">
            <div class="header">
                <h1>🔍 API Explorer</h1>
                <p>Comprehensive list of all available APIs and tools</p>
            </div>
            
            <div class="api-section">
                <h2 class="section-title">🏠 Core APIs</h2>
                <div class="api-grid">
                    <div class="api-card" onclick="testEndpoint('/api/hello', 'GET')">
                        <span class="api-method method-get">GET</span>
                        <h3>Hello World API</h3>
                        <div class="api-url">/api/hello</div>
                        <p class="api-description">Basic hello world endpoint with system information and status.</p>
                        <button class="test-btn">Test API</button>
                    </div>
                    
                    <div class="api-card" onclick="testEndpoint('/api/status', 'GET')">
                        <span class="api-method method-get">GET</span>
                        <h3>System Status</h3>
                        <div class="api-url">/api/status</div>
                        <p class="api-description">Get detailed system status including environment, versions, and features.</p>
                        <button class="test-btn">Test API</button>
                    </div>
                    
                    <div class="api-card" onclick="testEndpoint('/health', 'GET')">
                        <span class="api-method method-get">GET</span>
                        <h3>Health Check</h3>
                        <div class="api-url">/health</div>
                        <p class="api-description">Simple health check endpoint for monitoring and load balancers.</p>
                        <button class="test-btn">Test API</button>
                    </div>
                </div>
            </div>
            ...
            <div class="api-section">
                <h2 class="section-title">🔗 SAP Datasphere APIs</h2>
                <div class="api-grid">
                    <div class="api-card" onclick="testDatasphereConnect()">
                        <span class="api-method method-post">POST</span>
                        <h3>Connect to Datasphere</h3>
                        <div class="api-url">/api/datasphere/connect</div>
                        <p class="api-description">Establish connection to SAP Datasphere and retrieve available data products.</p>
                        <button class="test-btn">Test Connection</button>
                    </div>
                    
                    <div class="api-card" onclick="testEndpoint('/api/datasphere/products', 'GET')">
                        <span class="api-method method-get">GET</span>
                        <h3>Get Data Products</h3>
                        <div class="api-url">/api/datasphere/products</div>
                        <p class="api-description">Retrieve all available data products from SAP Datasphere with metadata.</p>
                        <button class="test-btn">Test API</button>
                    </div>
                </div>
            </div>
            ...
            <div class="api-section">
                ...
                <div class="api-grid">
                    <div class="api-card">
                        <span class="api-method method-get">GET</span>
                        <h3>API Explorer</h3>
                        <div class="api-url">/api-explorer</div>
                        <p class="api-description">This page - comprehensive API documentation and testing interface.</p>
                        <button class="test-btn" disabled>Current Page</button>
                    </div>
                    
                    <div class="api-card">
                        <span class="api-method method-get">GET</span>
                        <h3>Docker Environment</h3>
                        <div class="api-url">Port: 5000</div>
                        <p class="api-description">Running in Docker container with hot reload enabled for development.</p>
                        <button class="test-btn" disabled>Environment Info</button>
                    </div>
                </div>
            </div>
            
            <div class="api-section">
                <h2 class="section-title">📊 Response Examples</h2>
                <div class="api-grid">
                    <div class="api-card">
                        <h3>Typical Success Response</h3>
                        <pre>{
  "status": "success",
  ...
  "timestamp": "2024-01-21T10:30:00Z"
        ...
        <script>
            async function testEndpoint(url, method = 'GET') {
                ...
                results.innerHTML = `<h3>🔄 Testing ${method} ${url}...</h3>`;
                ...
                try {
                    ...
                    results.innerHTML = `
                        <h3>✅ ${method} ${url} - Success (${response.status})</h3>
                        <pre>${JSON.stringify(data, null, 2)}</pre>
                    `;
                } catch (error) {
                    results.innerHTML = `
                        <h3>❌ ${method} ${url} - Failed</h3>
            ...
            async function testDatasphereConnect() {
                const results = document.getElementById('results');
                results.style.display = 'block';
                results.innerHTML = '<h3>🔄 Testing Datasphere Connection...</h3>';
                ...
                try {
                    ...
                    results.innerHTML = `
                        <h3>✅ POST /api/datasphere/connect - Success (${response.status})</h3>
                        <h4>Request Body:</h4>
                        <pre>{
  "base_url": "https://demo-tenant.datasphere.cloud.sap",
  "space_id": "demo_space"
                    ...
                    results.innerHTML = `
                        <h3>❌ POST /api/datasphere/connect - Failed</h3>
                        <p>Error: ${error.message}</p>
                    `;
                }
