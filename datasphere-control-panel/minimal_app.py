    ...
    <body>
        <div class="header">
            <div class="header-content">
                <div class="logo">
                    <div>
                        <h1>SAP Catalog Integrator to AWS</h1>
...
def handle_dashboard() -> Dict[str, Any]:
    ...
    <div class="card">
        <h2>Data Viewer</h2>
        <p>Browse and explore the actual data from your time dimension tables.</p>
        <a href="/data" class="btn">View Table Data</a>
        <p style="margin-top: 15px; color: #c0c0c0;">
            Select any table to see its structure and sample data in a beautiful, 
            interactive format with SQL query examples.
        </p>
    </div>
    
    <div class="card">
        <h2>Synchronization Manager</h2>
        <p>Keep your AWS Glue catalog up-to-date with the latest Datasphere assets.</p>
        <a href="/sync" class="btn">Manage Sync</a>
        <p style="margin-top: 15px; color: #c0c0c0;">
            Trigger manual synchronization or monitor sync status. 
            Automatically creates and updates Glue tables with the latest metadata.
        </p>
    </div>
...
def handle_data_viewer(table_name: str = None) -> Dict[str, Any]:
    ...
    <div class="card">
        ...
        <div style="margin: 20px 0;">
            <label for="tableSelect" style="color: #78ff77; font-weight: 600; display: block; margin-bottom: 8px;">SelectTable:</label>
