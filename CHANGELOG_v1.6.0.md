...
Run against `partstown-1` (US20) on 2026-08-07. Two things the SAP
documentation does not state:

### Filtering is case-sensitive

Confirmed on `SCM_BUSINESS/OPEN_PO_DETAIL`, whose stored values are uppercase:

| Filter | Rows |
|---|---|
| `contains(MATNR,'KOOL')` | 6 |
| `contains(MATNR,'kool')` | **0** |
